...
def main():
    ...
    build_parser.add_argument("--margin", type=float, default=MetaGNNConfig.margin, help="Contrastive loss margin hyperparameter.")
    ...
    build_parser.add_argument("--contrastive_only", type=str2bool, default=MetaGNNConfig.contrastive_only, help="Interval for saving checkpoints.")
